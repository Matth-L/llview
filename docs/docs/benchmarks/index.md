...
<figure markdown>
  ...
  <figcaption>LLview Continuous Benchmark interface, showing OSU benchmark results</figcaption>
</figure>

LLview makes it simple to track performance over time by:

- **Automatic result collection**
  Pull benchmark outputs (e.g., CSV or JSON files) directly from your Git repository.
...
- **Embedded metadata**
  Include extra context such as job IDs, Git commit hashes, build timestamps, or any custom field right in your graph labels.
